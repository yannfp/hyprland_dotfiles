...
# Apps (Added Brave here)
echo -e "${rplc_ln}Installing applications"
# You may need to allow unfree packages for Brave
NIXPKGS_ALLOW_UNFREE=1 nix profile install nixpkgs#brave
